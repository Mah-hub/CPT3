 ...
 */
function sort(tables: any, column: string, direction: string): Table[] {
    if (direction === '' || column === '') {
        return tables;
    } else {
...
export class AdvancedService {
    ...
    private _search(): Observable<SearchResult> {
       ...
       let httpHeaders = new HttpHeaders({'Content-Type' : 'application/json', Authorization: "Token " +"eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJ1c2VybmFtZSI6InRlc3QiLCJlbWFpbCI6InRlc3RAdGVzdC5jb20iLCJleHAiOjE2Mzk0NjgzNTN9.EFCOoZbPqyIHao5-A2lnjU7MPaJLtZmC2JRgwmcZk4g"});
       let x =this.http.get(baseurl + '/api/auth/users',{headers :httpHeaders})
