...
export class Auth2Service {
  ...
  private storeTokens(tokens: Tokens) {
    console.log("EEEEEEEEEEEEEEEEeee",tokens)
    localStorage.setItem(this.JWT_TOKEN, tokens["tokens"]["access"]  );
    localStorage.setItem(this.REFRESH_TOKEN, tokens["tokens"]["refresh"] );
  }
