...
export class SidebarComponent implements OnInit, AfterViewInit, OnChanges {
  ...
  constructor(private eventService: EventService, private router: Router, public translate: TranslateService, private http: HttpClient,private usersService:UsersService) {
  ...
  initialize(): void {
   ...
   console.log("MEEEENUUUUUU",MENU)
    ...
    if(data["permissions"].indexOf("auth.view_group") == -1){
